...
public class PlayerControlView extends FrameLayout {
  ...
  private void updateTimeline() {
    @Nullable Player player = this.player;
//    androidx.media3.common.util.JLog.d("jianjun", "updateTimeline: " + player);
    if (player == null) {
      return;
    }
...
//      androidx.media3.common.util.JLog.d("jianjun", "multiWindowTimeBar: " + multiWindowTimeBar);
      int firstWindowIndex = multiWindowTimeBar ? 0 : currentWindowIndex;
      int lastWindowIndex = multiWindowTimeBar ? timeline.getWindowCount() - 1 : currentWindowIndex;
      for (int i = firstWindowIndex; i <= lastWindowIndex; i++) {
//        androidx.media3.common.util.JLog.d("jianjun", "windowIndex: " + i);
        if (i == currentWindowIndex) {
          currentWindowOffset = Util.usToMs(durationUs);
        }
        timeline.getWindow(i, window);
//        androidx.media3.common.util.JLog.d("jianjun", "getWindow: " + window.durationUs);
        ...
        androidx.media3.common.util.JLog.d("jianjun", "get duration form timeline durationUs: " + durationUs, new Throwable());
//        androidx.media3.common.util.JLog.d("jianjun", "form timeline durationUs: " + durationUs, new Throwable());
      }
...
//    androidx.media3.common.util.JLog.d("jianjun", "durationUs: " + durationUs);
